...
import { type FontKey, fontOptions } from "@/lib/admin/fonts/registry";
import type { ContentLayout, NavbarStyle, SidebarCollapsible, SidebarVariant } from "@/lib/admin/preferences/layout";
import {
  applyContentLayout,
  applyFont,
  applyNavbarStyle,
  ...
  applySidebarVariant,
} from "@/lib/admin/preferences/layout-utils";
import { PREFERENCE_DEFAULTS } from "@/lib/admin/preferences/preferences-config";
import { persistPreference } from "@/lib/admin/preferences/preferences-storage";
import { THEME_PRESET_OPTIONS, type ThemeMode, type ThemePreset } from "@/lib/admin/preferences/theme";
import { applyThemePreset } from "@/lib/admin/preferences/theme-utils";
